...
class DelayQueue(object):
    ...
    def __init__(self, conf):
        host, port, db, password = conf['host'], conf['port'], conf['db'], conf['password']
    ...
    def push(self, data):
        ...
        consum_time = time.time() + 30
        self.client.zadd(self.QUEUE_KEY, data_key, int(consum_time))

    def pop(self, num=1, previous=0):
        """pop多条数据
        :param num: pop多少个
